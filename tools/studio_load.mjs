...
const REQUIRED = [
  ...
  'skipDeadAt', 'inDeadZone', 'entryDepthAt', 'skipGapAt', 'scanValue', 'entryAnchors', 'pickEntry',
  ...
  'editRewriteCandidates', 'historyDiffers', 'editMissingChanges', 'valueAtPath', 'tier3TemplateOf',
  'moveBaseInfo', 'textsSyntaxError', 'textsTraitDupError', 'traitDescDupKeys', 'idOk',
