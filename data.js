...
const UPDATE_HISTORY = [
  { date:'2026-08-23', items:[
    { t:'新しいバージョンが用意できたとき、ロビーなど試合中でない場面ならその場で自動的に切り替わるようになりました。バックグラウンドから戻したときも確認します(試合中だけは待ちます)', g:['fix','general'] },
    ...
    { t:'試合中に予告なくアプリが再起動されることが無くなりました。新しいバージョンの用意ができても、次にタイトル画面へ来るまで待って自動で切り替わります(みなさんが何かを押す必要はありません)', g:['fix','general'] },
  ]},
