...
const UPDATE_HISTORY = [
  { date:'2026-08-23', items:[
    ...
    { t:'📖 遊び方ガイドに「用語集」を追加しました。ガッツ・安置・適正・段位RP・モン晶・円盤石・覚醒・転生など22項目の意味が読めます', g:['feature','general'] },
    { t:'マスモン登録の画面に「スキップすると、この試合の経験値は入りません」と出るようにしました', g:['general'] },
  ]},
  { date:'2026-08-23', items:[
    { t:'画面の外(暗いところ)をタップして閉じる動きと、ブラウザの「戻る」で1つ前に戻る動きを取り下げました。横向きで持つ関係で、意図しないところで画面が閉じてしまう原因になるためです。画面を閉じるのはこれまでどおり✕や「閉じる」からになります', g:['fix','general'] },
  ]},
  { date:'2026-08-23', items:[
    { t:'バトル画面に増やしていた表示をまとめて取り下げました。「☰」ボタン、画面外の敵を指す三角、技の射程表示、HPが減ったときの赤い縁を無くし、文字の大きさも元に戻しています', g:['fix','general'] },
    { t:'バトル中のメッセージを1行だけに戻しました(3行に増えて画面を覆っていました)', g:['fix','general'] },
    { t:'🚪 チーム戦で倒され、残っている味方がbotだけになったときの観戦画面に「試合を抜ける」を出すようにしました。仲間が残っているあいだは出ません(その人たちの試合が終わってしまうため)', g:['multi','general'] },
  ]},
  { date:'2026-08-23', items:[
    { t:'🗺️ ミニマップを元どおり「全体が見える」表示に戻しました(勝手に近くへ寄せてしまっていました)。近くを大きく見たいときはミニマップをタップすると切り替わります', g:['fix','general'] },
    { t:'⚡ 起動時の読み込みを元のやり方に戻しました。直したものがその場で反映されるようになります', g:['fix','general'] },
    { t:'感度・ボタン配置・音量などの設定を、アカウントで他の端末へ引き継ぐのをやめました。画面の大きさが違う端末どうしで設定が上書きし合うためです(これまでどおり端末ごとの設定になります)', g:['fix','general'] },
  ]},
  { date:'2026-08-23', items:[
    { t:'🔧 ロビーに出していた「🔄 更新」ボタンを取りやめました。更新はこれまでどおりタイトル画面の読み込み中に自動で済み、みなさんが何かを押す必要はありません。押させる手間・画面のズレ・更新が無いのに出る誤報でご迷惑をおかけしました', g:['fix','general'] },
    { t:'あわせて、試合中に予告なく再起動されることが無いようにしました。更新が用意できても、次にタイトル画面へ来るまで待ちます', g:['fix','general'] },
  ]},
  { date:'2026-08-23', items:[
    { t:'🔧 「更新があります」の嘘を根本から直しました。前回の修正では足りず、直したはずの中身自体が古いまま読み込まれるため効いていませんでした。これからは新しいバージョンの用意ができたときだけ出ます。「今すぐ更新」を押すと確実に最新へ切り替わります', g:['fix','general'] },
  ]},
  { date:'2026-08-23', items:[
    { t:'🔧 「更新があります」と嘘の案内が出ていたのを直しました。アプリを終了して開き直すたびに、更新など無いのに毎回出ていました', g:['fix','general'] },
    { t:'🔧 その「更新」ボタンがバナーの下に隠れて押せないことがあったのを直しました', g:['fix','general'] },
    { t:'📖 ヘルプから「遊び方ガイド」を開けるようにしました。オーラの相性・アイテム・状態変化の説明が、設定の奥にあって見つけられませんでした。ロビーの「🔰 はじめて」は、はじめての説明の見返しに役割を分けました', g:['general'] },
    { t:'🏆 ランキングで自分の順位が分かるようになりました。自分の行が光り、50位より下でも一番下に「あなた #順位」が出ます', g:['general','feature'] },
    { t:'画面の外(暗いところ)をタップしても閉じられるようになりました。取り消しのきかない画面(転生・覚醒・確認)はこれまでどおりボタンで選びます', g:['general'] },
    { t:'ブラウザの「戻る」で1つ前の画面へ戻れるようになりました。**試合中は戻る操作で試合が終わることはありません**', g:['general','fix'] },
    { t:'ヘッダーの⚙️👤🆕❓のボタンと、画面右上の✕を大きくしました(押し間違いが減ります)', g:['general'] },
    { t:'ショップやトレーニングで足りない物があるとき、押しても何も起きなかったのを直しました。何がいくつ足りないか・どこで手に入るかが出ます', g:['fix','general'] },
    { t:'🔇 音量設定に一括ミュートを追加しました', g:['general'] },
    { t:'📡 マルチの通信の遅れ(ms)を画面に出せるようにしました(設定から入り切り)', g:['multi','general'] },
    { t:'感度・視野角・上下反転・文字サイズ・音量などの設定が、ログインすると他の端末にも引き継がれるようになりました。バトル画面のボタン配置は、まだ配置を決めていない端末にだけ引き継ぎます(画面の大きさが違う端末で上書きし合わないため)', g:['general'] },
    { t:'ロビーの小さすぎた文字をまとめて読める大きさにしました。待機部屋のスクロールとリザルトのボタンの小ささも直しています', g:['general','fix'] },
  ]},
  { date:'2026-08-23', items:[
    { t:'🚪 試合の途中で抜けられるようになりました。バトル画面の「☰」から「リザルトへ抜ける」を選べます。それまでの戦績と報酬はそのまま受け取れます', g:['feature','general'] },
    { t:'倒されたあとの観戦画面に「リザルトへ」を追加しました。マルチで倒れたとき、最後の1人が決まるまで待たされることがなくなります。部屋に入っている側は、倒れたときに「観戦する」か「リザルトへ」かを選べます', g:['multi','general'] },
    { t:'⟳ リザルトに「もう一度」を追加しました。マルチでは部屋にいる仲間とそのまま続けて遊べます(部屋を作り直す必要がありません)', g:['feature','multi'] },
    { t:'待機画面が分かりやすくなりました。チーム戦では見出しが「チームメンバーを募集中」になり、あと何人で始まるのか・誰が始めるのかが別の行に出ます。Bot の待機枠は1行にまとめました', g:['multi','general'] },
    { t:'部屋を探す画面が5秒ごとに自動で更新されるようになりました。部屋の行にマップ名が出て、「⚡ 空いてる部屋に入る」で人数の多い部屋から順に入れます', g:['multi','general'] },
    { t:'部屋に入るとき「参加中…」と出るようになり、連打しても二重に入らなくなりました', g:['fix','multi'] },
    { t:'通信ができないときに「部屋を作る」を押すと、断りなく1人用の試合が始まっていたのを直しました。1人で遊ぶかどうかを選べます。圏外のときはマルチのボタンが沈み、押すと理由が出ます', g:['fix','multi'] },
    { t:'圏外のときに「募集中の部屋はありません」と出ていたのを直しました。通信に失敗した場合と、本当に部屋が無い場合で表示が分かれます。オフラインのときは画面の上に印が出ます', g:['fix','multi'] },
    { t:'マルチで通信の遅れ(ms)を画面の隅に出せるようにしました。設定から入り切りできます', g:['multi','general'] },
    { t:'マルチのゲスト側で、当たったように見えたのに相手のHPが減らないとき、出したままだった命中の印と数字が消えるようになりました', g:['fix','multi'] },
    { t:'撃破ログを画面の右端へ戻しました。視点回転ボタンと重なりますが、重なった部分もボタンとして押せます', g:['general'] },
    { t:'バトル中のメッセージの黒い帯をなくし、文字だけを縁取りで出すようにしました。画面が見やすくなります', g:['general'] },
    { t:'マスモンの詳細で、転生や覚醒ができるようになっているときは、そのボタンが一番上に出るようになりました', g:['general'] },
  ]},
  { date:'2026-08-22', items:[
    ...
    { t:'❤️ HPが25%を切ると画面のふちが赤く脈打って知らせます', g:['feature','general'] },
    { t:'🗺️ ミニマップが近くを大きく映すようになりました。今までは世界全体を1枚に収めていたため、戦っている相手が自分の点に重なって見えませんでした。タップで全体表示と切り替えられます', g:['feature','general'] },
    { t:'画面の外にいる敵を、画面のふちの三角で知らせるようにしました', g:['feature','general'] },
    { t:'🔍 岩や山ごしでも照準が赤くなり「当たる」と思って撃ってしまう不具合を直しました', g:['fix','general'] },
    { t:'🔤 バトル中の文字と体力バーを大きくしました。⚙️設定 →「視点設定」で「大」にもできます', g:['general'] },
    { t:'技パネルに射程を表示するようにしました。ガッツが足りないときはFIREボタンが灰色になります', g:['feature','general'] },
    { t:'やけど・鈍足・どくにも残り時間を表示するようにしました(こおりに続いて)', g:['general'] },
    { t:'⏱️ 安全圏が縮む10秒前に予告が出るようになりました', g:['feature','general'] },
    { t:'お知らせ(トースト)が最大3件まで縦に並ぶようになりました。今までは1件しか出せず、大事な知らせが次の知らせで消えたり、長い文が両端で切れて読めませんでした', g:['fix','general'] },
  ...
  { date:'2026-08-22', items:[
    { t:'🎯 FIREボタンを押した指をそのまま滑らせると視点が動くようになりました。右手だけで「撃ちながら狙う」ができます。設定 →「視点設定」でOFFにもできます(はじめはON)', g:['feature','general'] },
    { t:'FIREを押したまま指が少しズレても発射が止まらなくなりました', g:['fix','general'] },
  ...
  { date:'2026-08-22', items:[
    ...
    { t:'ホストの通信が切れたときに、待っている人がずっと待たされたり、試合中に世界が止まったまま抜けられなくなる不具合を直しました。切れたと分かった時点でお知らせを出し、リザルトへ進めます', g:['fix','multi'] },
    { t:'通信が切れた相手のモンスターが、最後に入力した方向へ走り続ける不具合を直しました', g:['fix','multi'] },
    ...
    { t:'アプリが勝手に読み込み直さなくなりました。試合中やガチャの演出中に着信などで離れて戻っても、そのまま続けられます。新しいバージョンが出たときはロビーに「🔄 更新」が出るので、好きなときに押してください', g:['fix','general'] },
  ...
  { date:'2026-08-19', items:[
    { t:'待機画面でチームメンバーが見えない不具合を修正しました。実際に隠れていたのは「対戦相手を探しています…」のパネルだったため、そちらの横幅を狭くしました。またチームメンバーが自分のマスモンから離れて見えていたのも、位置を調整して直しました', g:['fix','multi'] },
  ]},
  { date:'2026-08-19', items:[
    { t:'待機画面のチームメンバー表示を調整しました。右側のパネルに隠れて見えなかった分が見えるように、待機中だけ右側の幅を狭くしました。チームメンバーにも歩行モーションを付け、自分より少し上側(奥)に立つようにしました', g:['general','multi'] },
  ]},
  { date:'2026-08-19', items:[
    { t:'チーム戦で部屋を作った時、待機画面の自分の斜め後ろ左右にチームメンバーのモンスターを表示するようにしました。他のプレイヤーが参加してチームメンバーが変わると表示も自動で切り替わります(シングルのマルチPvPでは表示しません)', g:['general','multi'] },
  ]},
  { date:'2026-08-19', items:[
    { t:'チーム戦を部屋を使わず1人で始める「ソロ出撃」を廃止しました。チーム戦は部屋を作って遊んでください', g:['general','multi'] },
  ]},
  { date:'2026-08-19', items:[
    { t:'部屋の待機画面で表示される「あなたのマスモン」のBot待機枠と、実際に試合で参戦するマスモンが一致しないことがある不具合を修正しました', g:['fix','multi'] },
  ]},
  { date:'2026-08-19', items:[
